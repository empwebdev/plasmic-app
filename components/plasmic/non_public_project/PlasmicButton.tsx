...
import sty from "./PlasmicButton.module.css"; // plasmic-import: OG-B4su9scYB/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__yPlbi, {
          [sty.freeBoxcolor_neutral__yPlbiGQvN2]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__yPlbi7N0ACh8Sd]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__yPlbiapN6T]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__yPlbi5UqAa]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__yPlbi4VbzL]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__yPlbiNCnaX]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__yPlbiYyMx6]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__yPlbiCh8Sd]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__yqePc, {
            [sty.freeBoxcolor_neutral__yqePcgQvN2]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__yqePcgQvN2PPf1Q]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__yqePCaehiA]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__yqePc5UqAa]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__yqePcnCnaX]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__yqePcYyMx6]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__yqePcCh8Sd]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__qjWxZ)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__fE7Ff, {
            [sty.freeBoxiconEnd__fE7Ff2FtTu]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__fE7Ff5UqAa]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__fE7FfNCnaX]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__fE7FfYyMx6]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__vwnw2)}
                role={"img"}
              />
            ),
