...
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: 5PnTE2dDorIh/css
...
const PlasmicDescendants = {
  root: ["root", "headerMenu", "freeBox", "header"],
  headerMenu: ["headerMenu", "freeBox", "header"],
