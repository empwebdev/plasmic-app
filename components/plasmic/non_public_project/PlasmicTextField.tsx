...
import Label from "../../Label"; // plasmic-import: 5FpHekbI84a2/component
import TextInput from "../../TextInput"; // plasmic-import: 2lIZmH-Ye0_4/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: WqJ7AUL7GeLx/component
import Description from "../../Description"; // plasmic-import: F-JrBTTNqhzt/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: p66-mMsMW6dx/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__sk7Dc, {
          [sty.freeBoxiconEnd__sk7DcIaenW]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__sk7Dc9VdJh]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__sk7DChppX9]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__hkad3, {
            [sty.freeBoxiconStart__hkad39VdJh]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__hkad3HppX9]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__zyIoo)}
                role={"img"}
              />
            ),
        ...
        {(hasVariant($state, "multiLine", "multiLine") ? false : true) ? (
          <TextInput
            ...
            placeholder={args.enterEmailAddress}
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ftTqe, {
            [sty.freeBoxiconEnd__ftTqeIaenW]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__ftTqe9VdJh]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__c1ZBq)}
                role={"img"}
              />
            ),
